...
from ...io.exp import gltf2_io_image_data
from ...io.com import gltf2_io_debug
from .gltf2_blender_image import Channel, ExportImage, FillImage
    ...
    for result, socket in zip(results, sockets):
        ...
        if export_settings['gltf_keep_original_textures']:
            ...
            for elem in result.path:
                # 3.2 changed to 3.3 way if isinstance(elem.from_node, bpy.types.ShaderNodeSeparateRGB):

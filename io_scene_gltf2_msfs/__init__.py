...
class ExportExtendedGLTF2_Base:
    ...
    def execute(self, context):
        ...
        from .blender.exp import gltf2_blender_batch_export
...
def menu_func_export(self, context):
    self.layout.operator(ExportExtendedGLTF2.bl_idname, text='extended glTF 2.0 (.glb/.gltf) for MSFS (v0.42.11)')
...
class ImportMSFSGLTF2(Operator, ImportHelper):
    ...
    def unit_import(self, filename, import_settings, addon_settings):
        import time
        from .io.com.gltf2_io_gltf import glTFImporter, ImportError
